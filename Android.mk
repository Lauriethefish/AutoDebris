...
LOCAL_LDLIBS += -llog
LOCAL_CFLAGS += -I'extern/libil2cpp/il2cpp/libil2cpp' -DID='"auto-debris"' -DVERSION='"0.1.5"' -I'./shared' -I'./extern' -isystem'extern/codegen/include'
